/********************金逸晨**************************
****************1.28’    7PIN SPI TFT FOR  AT89S52/STC12*************
*****AT89S52驱动**************************
***** P20----SCL  ,  P21----SDA   ,  P22----DC
	  P23-----CS  , P24-----RST  (可不接，本模块有上电复位电路) 
***** BY: 
...
#define clr_6   0xBF
#define clr_7   0x7F
/**********SPI引脚分配，连接液晶屏，更具实际情况修改*********/

#define SPI_SCK_0  P2 &=clr_0        //P2_0      
#define SPI_SCK_1  P2|=set_0       
#define SPI_SDA_0  P2&=clr_1        //P2_1        
#define SPI_SDA_1  P2|=set_1
#define SPI_DC_0  P2&=clr_2        //P2_2        
#define SPI_DC_1  P2|=set_2
#define SPI_CS_0  P2&=clr_3           //P2_3
#define SPI_CS_1  P2|=set_3
#define SPI_RST_0  P2&=clr_4          //P2_4
#define SPI_RST_1  P2|=set_4
//定义显示区域大小，偏移
